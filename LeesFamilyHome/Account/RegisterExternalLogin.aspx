<%@ Page Title="외부 로그인 등록" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="LeesFamilyHome.Account.RegisterExternalLogin" Async="true" %>
